...
public class Graph implements Iterable<Graph.Vertex> {
    ...
    /**
     * Nested class that represents an edge of a SP5.ixs180019.Graph
     */
	...
	*/
    ...
    /**
     * Constructor for SP5.ixs180019.Graph
     * 
     * @param n
	...
	System.out.println("SP5.ixs180019.Graph: n: " + size() + ", m: " + edgeSize() + ", directed: " + directed + ", Edge weights: " + hasEdgeWeights);
	for(Vertex u: this) {
	    System.out.print(u + " : ");
    ...
    // Utilities of SP5.ixs180019.Graph class:
    /**
     * Find vertex no. n
     * @param n
     *           : int
